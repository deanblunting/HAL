...
@dataclass
class HALConfig:
    """Configuration parameters for HAL algorithm."""
    ...
    spring_layout_k: float = None  # Auto-compute if None
    rasterization_conflicts_max_iterations: int = 100
    use_louvain_communities: bool = True  # Use Louvain algorithm for community detection
    community_resolution: float = 1.0  # Resolution parameter for community detection
    
    # Cost calculation weights and baselines
